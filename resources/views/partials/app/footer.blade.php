...
<footer class="tp-footer-2-area p-relative">
   <div class="tp-footer-overlay" data-background="{{ asset('assets/img/footer/footer-2-bg.png') }}">
      <div class="tp-footer-2-shape">
         <img src="{{ asset('assets/img/footer/shape-1.png') }}" alt="">
      </div>
      <div class="container">
               ...
               <div class="tp-footer-widget tp-footer-2-col-3">
                  ...
                  <div class="tp-footer-widget-content">
                     <div class="tp-footer-info">
                        <p>We are among the fastest growing ITES company <br> developing and designing customized softwares as well as websites for our clients. </p>
                        <div class="tp-footer-main-location">
                           <a href="https://www.google.com/maps/place/254+Lillian+Blvd,+Holbrook,+NY+11741,+USA/@40.7937446,-73.0774993,17z/data=!3m1!4b1!4m5!3m4!1s0x89e8483b469d706f:0xa6841f8aafc2ef19!8m2!3d40.7937446!4d-73.0753106">
                              <i class="fa-sharp fa-light fa-location-dot"></i> K-305 Ajnara Home Sec16B, Noida Extension</a>
                        </div>
                        <div class="tp-footer-main-mail">
                           <a href="#"><i class="fa-regular fa-phone"></i> +91-120-413-6262</a>
                        </div>
                     </div>
                  </div>
               </div>
         ...
         <div class="row align-items-center">
            <div class="col-lg-2 col-md-2">
               <div class="tp-footer-2-logo">
                  <img src="{{ asset('assets/img/logo/footer-logo2.png') }}" alt="">
               </div>
            </div>
            ...
            <div class="col-lg-2 col-md-6">
               ...
               <div class="ddf">
                  <p>Phone:</p>
                  <span><a href="tel:01900678956">+91 999 965 6954</a></span>
               </div>
               </div>
            </div>
         </div>
...
<script src="{{ asset('assets/js/scrool-triger.js') }}"></script>
